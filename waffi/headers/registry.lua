...
ffi.cdef [[
  ...
  typedef HANDLE_ HKEY_; //Alias max ffi ptr
  static const HKEY_ HKEY_CLASSES_ROOT = -2147483648;
  static const HKEY_ HKEY_CURRENT_USER = -2147483647;
  static const HKEY_ HKEY_LOCAL_MACHINE = -2147483646;
  static const HKEY_ HKEY_USERS = -2147483645;
  static const HKEY_ HKEY_PERFORMANCE_DATA = -2147483644;
  static const HKEY_ HKEY_PERFORMANCE_TEXT = -2147483568;
  static const HKEY_ HKEY_PERFORMANCE_NLSTEXT = -2147483552;
  static const HKEY_ HKEY_CURRENT_CONFIG = -2147483643;
  static const HKEY_ HKEY_DYN_DATA = -2147483642;
