...
ffi.cdef [[
  ...
  typedef LPSTR RPC_STR; //Alias
  typedef LPWSTR RPC_WSTR; //Alias
  ...
  typedef struct RPC_PROTSEQ_VECTORA {
    unsigned int Count;
    RPC_STR Protseq[1];
  } RPC_PROTSEQ_VECTORA;
  typedef struct RPC_PROTSEQ_VECTORW {
    unsigned int Count;
    RPC_WSTR Protseq[1];
  } RPC_PROTSEQ_VECTORW;
  typedef union WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_A_u {
    RPC_STR Reserved;
  } WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_A_u;
  typedef union WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_W_u {
    RPC_WSTR Reserved;
  } WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_W_u;
  typedef unsigned long WINAPI_RPC_BHT; //Alias
  typedef struct RPC_BINDING_HANDLE_TEMPLATE_V1_A {
    unsigned long Version;
    WINAPI_RPC_BHT Flags;
    unsigned long ProtocolSequence;
    RPC_STR NetworkAddress;
    RPC_STR StringEndpoint;
    WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_A_u u1;
    UUID ObjectUuid;
  } RPC_BINDING_HANDLE_TEMPLATE_V1_A;
  typedef struct RPC_BINDING_HANDLE_TEMPLATE_V1_W {
    unsigned long Version;
    WINAPI_RPC_BHT Flags;
    unsigned long ProtocolSequence;
    RPC_WSTR NetworkAddress;
    RPC_WSTR StringEndpoint;
    WINAPI_RPC_BINDING_HANDLE_TEMPLATE_V1_W_u u1;
    UUID ObjectUuid;
  ...
  typedef struct SEC_WINNT_AUTH_IDENTITY_A {
    RPC_STR User;
  ...
  typedef struct RPC_BINDING_HANDLE_SECURITY_V1_A {
    unsigned long Version;
    RPC_STR ServerPrincName;
    WINAPI_RPC_C_AUTHN_LEVEL AuthnLevel;
    WINAPI_RPC_C_AUTHN_SVC AuthnSvc;
    SEC_WINNT_AUTH_IDENTITY_A* AuthIdentity;
    RPC_SECURITY_QOS* SecurityQos;
  } RPC_BINDING_HANDLE_SECURITY_V1_A;
  typedef struct RPC_BINDING_HANDLE_SECURITY_V1_W {
    unsigned long Version;
