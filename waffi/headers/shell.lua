...
# pragma pack( pop )
  ...
  typedef UINT_PTR_ WINAPI_SEE_HINSTANCE_; //Alias max ffi ptr
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_FNF = 2;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_PNF = 3;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_ACCESSDENIED = 5;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_OOM = 8;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_DLLNOTFOUND = 32;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_SHARE = 26;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_ASSOCINCOMPLETE = 27;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_DDETIMEOUT = 28;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_DDEFAIL = 29;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_DDEBUSY = 30;
  static const WINAPI_SEE_HINSTANCE_ SE_ERR_NOASSOC = 31;
  ...
  typedef SHELLEXECUTEINFOA *LPSHELLEXECUTEINFOA; //Pointer
  ...
  typedef SHELLEXECUTEINFOW *LPSHELLEXECUTEINFOW; //Pointer
