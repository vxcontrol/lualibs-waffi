...
ffi.cdef [[
  ...
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_INFO = 0x00;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_START = 0x01;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_END = 0x02;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_STOP = 0x02;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_DC_START = 0x03;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_DC_END = 0x04;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_EXTENSION = 0x05;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_REPLY = 0x06;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_DEQUEUE = 0x07;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_RESUME = 0x07;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_CHECKPOINT = 0x08;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_SUSPEND = 0x08;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_WINEVT_SEND = 0x09;
  static const WINAPI_EVENT_TRACE_TYPE EVENT_TRACE_TYPE_WINEVT_RECEIVE = 0XF0;
  typedef UCHAR WINAPI_TRACE_LEVEL; //Alias
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_NONE = 0;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_FATAL = 1;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_ERROR = 2;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_WARNING = 3;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_INFORMATION = 4;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_VERBOSE = 5;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_RESERVED6 = 6;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_RESERVED7 = 7;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_RESERVED8 = 8;
  static const WINAPI_TRACE_LEVEL TRACE_LEVEL_RESERVED9 = 9;
  ...
  typedef EVENT_TRACE_LOGFILEA *PEVENT_TRACE_LOGFILEA; //Pointer
  typedef struct EVENT_TRACE_LOGFILEW {
    LPWSTR LogFileName;
    LPWSTR LoggerName;
    LONGLONG CurrentTime;
    ULONG BuffersRead;
  ...
  typedef EVENT_TRACE_LOGFILEW *PEVENT_TRACE_LOGFILEW; //Pointer
  ...
  static const WINAPI_EventLogType EVENTLOG_SUCCESS = 0x0000;
  static const WINAPI_EventLogType EVENTLOG_ERROR_TYPE = 0x0001;
  static const WINAPI_EventLogType EVENTLOG_WARNING_TYPE = 0x0002;
  static const WINAPI_EventLogType EVENTLOG_INFORMATION_TYPE = 0x0004;
  static const WINAPI_EventLogType EVENTLOG_AUDIT_SUCCESS = 0x0008;
  static const WINAPI_EventLogType EVENTLOG_AUDIT_FAILURE = 0x0010;
  typedef ULONG WINAPI_EventActivity; //Alias
  static const WINAPI_EventActivity EVENT_ACTIVITY_CTRL_GET_ID = 1;
  static const WINAPI_EventActivity EVENT_ACTIVITY_CTRL_SET_ID = 2;
  static const WINAPI_EventActivity EVENT_ACTIVITY_CTRL_CREATE_ID = 3;
  static const WINAPI_EventActivity EVENT_ACTIVITY_CTRL_GET_SET_ID = 4;
  static const WINAPI_EventActivity EVENT_ACTIVITY_CTRL_CREATE_SET_ID = 5;
]]
