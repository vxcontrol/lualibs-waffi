require( 'waffi.headers.common' )
require( 'waffi.headers.ntstatus' )
require( 'waffi.internal.internal' )
...
ffi.cdef [[
  ...
  typedef DEVMODEA *LPDEVMODEA; //Pointer
  typedef DEVMODEA *PDEVMODEA; //Pointer
  ...
  typedef DEVMODEW *LPDEVMODEW; //Pointer
  typedef DEVMODEW *PDEVMODEW; //Pointer
  typedef void *HANDLE; //Handle
  typedef UINT_PTR_ HANDLE_; //Alias max ffi ptr
  static const HANDLE_ NULL = 0;
  ...
  typedef HANDLE_ HKL_; //Alias max ffi ptr
  typedef HANDLE HBITMAP; //Alias
  typedef HANDLE HENHMETAFILE; //Alias
  typedef HANDLE WINAPI_ProcessHandle; //Alias
  typedef HANDLE_ WINAPI_ProcessHandle_; //Alias max ffi ptr
  static const WINAPI_ProcessHandle_ GetCurrentProcess_func_ = -1;
  typedef HANDLE WINAPI_ThreadHandle; //Alias
  typedef HANDLE_ WINAPI_ThreadHandle_; //Alias max ffi ptr
  static const WINAPI_ThreadHandle_ GetCurrentThread_func_ = -2;
  ...
  typedef GUID *PGUID; //Pointer
  typedef const GUID *LPCGUID; //Pointer
  typedef GUID *REFGUID; //Pointer
  typedef GUID CLSID; //Alias
  typedef CLSID *LPCLSID; //Pointer
  ...
  static const ACCESS_MASK GENERIC_READ = 0x80000000L;
  static const ACCESS_MASK GENERIC_WRITE = 0x40000000L;
  ...
  static const WINAPI_FILE_ACCESS_MASK FILE_SHARE_READ = 0x00000001;
  static const WINAPI_FILE_ACCESS_MASK FILE_SHARE_WRITE = 0x00000002;
  typedef ACCESS_MASK WINAPI_PROCESS_ACCESS_MASK; //Alias
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_TERMINATE = 0x0001;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_CREATE_THREAD = 0x0002;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_SET_SESSIONID = 0x0004;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_VM_OPERATION = 0x0008;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_VM_READ = 0x0010;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_VM_WRITE = 0x0020;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_DUP_HANDLE = 0x0040;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_CREATE_PROCESS = 0x0080;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_SET_QUOTA = 0x0100;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_SET_INFORMATION = 0x0200;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_QUERY_INFORMATION = 0x0400;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_SUSPEND_RESUME = 0x0800;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_QUERY_LIMITED_INFORMATION = 0x1000;
  static const WINAPI_PROCESS_ACCESS_MASK PROCESS_ALL_ACCESS = 0x001FFFF;
  ...
  typedef const RECT *LPCRECT; //Pointer
  typedef RECT RECTL; //Alias
  typedef const RECTL *LPCRECTL; //Pointer
...
//static const WINAPI_STARTUPINFO_ShowWindow SW_FORCEMINIMIZE = 11;
  ...
  typedef STARTUPINFOA *LPSTARTUPINFOA; //Pointer
  ...
  typedef WIN32_FIND_DATAA *LPWIN32_FIND_DATAA; //Pointer
  ...
  typedef WIN32_FIND_DATAW *LPWIN32_FIND_DATAW; //Pointer
  ...
  typedef OSVERSIONINFOA *LPOSVERSIONINFOA; //Pointer
  ...
  typedef OSVERSIONINFOW *LPOSVERSIONINFOW; //Pointer
  ...
  typedef OSVERSIONINFOEXA *LPOSVERSIONINFOEXA; //Pointer
  ...
  typedef OSVERSIONINFOEXW *LPOSVERSIONINFOEXW; //Pointer
...
ffi.cdef[[
  ...
  typedef ACTCTXA *PACTCTXA; //Pointer
  ...
  typedef ACTCTXW *PACTCTXW; //Pointer
