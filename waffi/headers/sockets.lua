...
ffi.cdef[[
  ...
  typedef ADDRINFOEXA *PADDRINFOEXA; //Pointer
  ...
  typedef ADDRINFOEXW *PADDRINFOEXW; //Pointer
  typedef UINT_PTR SOCKET; //Alias
  typedef UINT_PTR_ SOCKET_; //Alias max ffi ptr
  static const SOCKET_ INVALID_SOCKET = -1;
  enum { FD_SETSIZE = 64 };
  ...
  typedef struct WSAPROTOCOL_INFOA {
    ...
    CHAR szProtocol[WSAPROTOCOL_LEN_plus_1];
  } WSAPROTOCOL_INFOA;
  typedef WSAPROTOCOL_INFOA *LPWSAPROTOCOL_INFOA; //Pointer
  typedef struct WSAPROTOCOL_INFOW {
    ...
    DWORD dwMessageSize;
    DWORD dwProviderReserved;
    WCHAR szProtocol[WSAPROTOCOL_LEN_plus_1];
  } WSAPROTOCOL_INFOW;
  typedef WSAPROTOCOL_INFOW *LPWSAPROTOCOL_INFOW; //Pointer
  ...
  typedef struct WSANAMESPACE_INFOA {
    GUID NSProviderId;
    DWORD dwNameSpace;
    BOOL fActive;
    DWORD dwVersion;
  ...
  typedef WSANAMESPACE_INFOA *LPWSANAMESPACE_INFOA; //Pointer
  typedef struct WSANAMESPACE_INFOW {
    GUID NSProviderId;
    DWORD dwNameSpace;
    BOOL fActive;
    DWORD dwVersion;
  ...
  typedef WSANAMESPACE_INFOW *LPWSANAMESPACE_INFOW; //Pointer
  typedef struct BLOB {
    ULONG cbSize;
    BYTE* pBlobData;
  } BLOB;
  typedef BLOB *LPBLOB; //Pointer
  typedef struct WSANAMESPACE_INFOEXA {
    GUID NSProviderId;
    DWORD dwNameSpace;
    BOOL fActive;
    DWORD dwVersion;
  ...
  typedef WSANAMESPACE_INFOEXA *LPWSANAMESPACE_INFOEXA; //Pointer
  typedef struct WSANAMESPACE_INFOEXW {
    GUID NSProviderId;
    DWORD dwNameSpace;
    BOOL fActive;
    DWORD dwVersion;
  ...
  typedef WSANAMESPACE_INFOEXW *LPWSANAMESPACE_INFOEXW; //Pointer
  typedef struct WSANSCLASSINFOA {
    LPSTR lpszName;
    DWORD dwNameSpace;
    DWORD dwValueType;
    DWORD dwValueSize;
  ...
  typedef WSANSCLASSINFOA *LPWSANSCLASSINFOA; //Pointer
  typedef struct WSANSCLASSINFOW {
    LPWSTR lpszName;
    DWORD dwNameSpace;
    DWORD dwValueType;
    DWORD dwValueSize;
  ...
  typedef WSANSCLASSINFOW *LPWSANSCLASSINFOW; //Pointer
  typedef struct WSASERVICECLASSINFOA {
    LPGUID lpServiceClassId;
    LPSTR lpszServiceClassName;
    DWORD dwCount;
    LPWSANSCLASSINFOA lpClassInfos;
  } WSASERVICECLASSINFOA;
  typedef WSASERVICECLASSINFOA *LPWSASERVICECLASSINFOA; //Pointer
  typedef struct WSASERVICECLASSINFOW {
    LPGUID lpServiceClassId;
    LPWSTR lpszServiceClassName;
    DWORD dwCount;
    LPWSANSCLASSINFOW lpClassInfos;
  } WSASERVICECLASSINFOW;
  typedef WSASERVICECLASSINFOW *LPWSASERVICECLASSINFOW; //Pointer
  ...
  typedef WSAQUERYSETA *LPWSAQUERYSETA; //Pointer
  typedef struct WSAQUERYSETW {
    DWORD dwSize;
  ...
  typedef WSAQUERYSETW *LPWSAQUERYSETW; //Pointer
