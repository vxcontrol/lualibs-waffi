...
ffi.cdef [[
  ...
  typedef struct OBJECTS_AND_NAME_A {
    DWORD ObjectsPresent;
  ...
  typedef OBJECTS_AND_NAME_A *POBJECTS_AND_NAME_A; //Pointer
  typedef struct OBJECTS_AND_NAME_W {
    DWORD ObjectsPresent;
    SE_OBJECT_TYPE ObjectType;
  ...
  typedef OBJECTS_AND_NAME_W *POBJECTS_AND_NAME_W; //Pointer
  typedef union WINAPI_TRUSTEE_A_u {
    LPSTR ptstrName;
    SID* pSid;
  ...
  typedef TRUSTEE_A *PTRUSTEE_A; //Pointer
  typedef union WINAPI_TRUSTEE_W_u {
    LPWSTR ptstrName;
    SID* pSid;
    OBJECTS_AND_SID* pObjectsAndSid;
  ...
  typedef TRUSTEE_W *PTRUSTEE_W; //Pointer
  typedef struct EXPLICIT_ACCESS_A {
    ACCESS_MASK grfAccessPermissions;
    ACCESS_MODE grfAccessMode;
    WINAPI_AceFlags grfInheritance;
    TRUSTEE_A Trustee;
  } EXPLICIT_ACCESS_A;
  typedef EXPLICIT_ACCESS_A *PEXPLICIT_ACCESS_A; //Pointer
  ...
  typedef EXPLICIT_ACCESS_W *PEXPLICIT_ACCESS_W; //Pointer
...
# pragma pack( pop )
  ...
  typedef struct CREDENTIAL_ATTRIBUTEA {
    LPSTR Keyword;
    DWORD Flags;
    DWORD ValueSize;
    LPBYTE Value;
  } CREDENTIAL_ATTRIBUTEA;
  typedef CREDENTIAL_ATTRIBUTEA *PCREDENTIAL_ATTRIBUTEA; //Pointer
  typedef struct CREDENTIAL_ATTRIBUTEW {
    LPWSTR Keyword;
    DWORD Flags;
    DWORD ValueSize;
    LPBYTE Value;
  } CREDENTIAL_ATTRIBUTEW;
  typedef CREDENTIAL_ATTRIBUTEW *PCREDENTIAL_ATTRIBUTEW; //Pointer
  ...
  typedef CREDENTIALA *PCREDENTIALA; //Pointer
  ...
  typedef CREDENTIALW *PCREDENTIALW; //Pointer
  typedef struct CREDENTIAL_TARGET_INFORMATIONA {
    LPSTR TargetName;
  ...
  typedef CREDENTIAL_TARGET_INFORMATIONA *PCREDENTIAL_TARGET_INFORMATIONA; //Pointer
  typedef struct CREDENTIAL_TARGET_INFORMATIONW {
    LPWSTR TargetName;
  ...
  typedef CREDENTIAL_TARGET_INFORMATIONW *PCREDENTIAL_TARGET_INFORMATIONW; //Pointer
