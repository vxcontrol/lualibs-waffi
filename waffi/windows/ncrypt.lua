...
ffi.cdef [[
  typedef VOID NCRYPT_SSL_CIPHER_LENGTHS; //Alias
  typedef VOID NCRYPT_SSL_CIPHER_SUITE; //Alias
  ...
  SECURITY_STATUS SslGetCipherSuitePRFHashAlgorithm(  NCRYPT_PROV_HANDLE hSslProvider, DWORD dwProtocol, DWORD dwCipherSuite, DWORD dwKeyType, WCHAR* szPRFHash, DWORD dwFlags);
