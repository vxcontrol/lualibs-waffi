...
ffi.cdef[[
  ...
  typedef VOID CSR_API_MESSAGE; //Alias
  ...
  LPSTR                        RtlIpv4AddressToStringA(                            const IN_ADDR* Addr, LPSTR S);
  LPWSTR                       RtlIpv4AddressToStringW(                            const IN_ADDR* Addr, LPWSTR S);
  NTSTATUS                     RtlIpv4AddressToStringExA(                          const IN_ADDR* Address, USHORT Port, LPSTR AddressString, PULONG AddressStringLength);
  NTSTATUS                     RtlIpv4AddressToStringExW(                          const IN_ADDR* Address, USHORT Port, LPWSTR AddressString, PULONG AddressStringLength);
  NTSTATUS                     RtlIpv4StringToAddressA(                            PCSTR String, BOOLEAN Strict, LPSTR* Terminator, IN_ADDR* Addr);
  NTSTATUS                     RtlIpv4StringToAddressW(                            PCWSTR String, BOOLEAN Strict, LPWSTR* Terminator, IN_ADDR* Addr);
  ...
  LPSTR                        RtlIpv6AddressToStringA(                            const IN6_ADDR* Addr, LPSTR S);
  LPWSTR                       RtlIpv6AddressToStringW(                            const IN6_ADDR* Addr, LPWSTR S);
  NTSTATUS                     RtlIpv6AddressToStringExA(                          const IN6_ADDR* Address, ULONG ScopeId, USHORT Port, LPSTR AddressString, PULONG AddressStringLength);
  NTSTATUS                     RtlIpv6AddressToStringExW(                          const IN6_ADDR* Address, ULONG ScopeId, USHORT Port, LPWSTR AddressString, PULONG AddressStringLength);
  NTSTATUS                     RtlIpv6StringToAddressA(                            PCSTR String, PCSTR* Terminator, IN6_ADDR* Addr);
  NTSTATUS                     RtlIpv6StringToAddressW(                            PCWSTR String, PCWSTR* Terminator, IN6_ADDR* Addr);
  NTSTATUS                     RtlIpv6StringToAddressExA(                          PCSTR AddressString, IN6_ADDR* Address, PULONG ScopeId, PUSHORT Port);
  NTSTATUS                     RtlIpv6StringToAddressExW(                          PCWSTR AddressString, IN6_ADDR* Address, PULONG ScopeId, PUSHORT Port);
  ...
  RTL_UNLOAD_EVENT_TRACE *     RtlGetUnloadEventTrace(                             );
