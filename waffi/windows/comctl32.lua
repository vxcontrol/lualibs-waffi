...
ffi.cdef[[
  ...
  static const WINAPI_WSB_Prop WSB_PROP_CYVSCROLL = 0x00000001;
  static const WINAPI_WSB_Prop WSB_PROP_CXHSCROLL = 0x00000002;
  static const WINAPI_WSB_Prop WSB_PROP_CYHSCROLL = 0x00000004;
  static const WINAPI_WSB_Prop WSB_PROP_CXVSCROLL = 0x00000008;
  static const WINAPI_WSB_Prop WSB_PROP_CXHTHUMB = 0x00000010;
  static const WINAPI_WSB_Prop WSB_PROP_CYVTHUMB = 0x00000020;
  static const WINAPI_WSB_Prop WSB_PROP_VBKGCOLOR = 0x00000040;
  static const WINAPI_WSB_Prop WSB_PROP_HBKGCOLOR = 0x00000080;
  static const WINAPI_WSB_Prop WSB_PROP_VSTYLE = 0x00000100;
  static const WINAPI_WSB_Prop WSB_PROP_HSTYLE = 0x00000200;
  static const WINAPI_WSB_Prop WSB_PROP_WINSTYLE = 0x00000400;
  static const WINAPI_WSB_Prop WSB_PROP_PALETTE = 0x00000800;
  static const WINAPI_WSB_Prop WSB_PROP_MASK = 0x00000FFF;
  typedef DWORD WINAPI_ILP_Flags; //Alias
  static const WINAPI_ILP_Flags ILP_NORMAL = 0;
  static const WINAPI_ILP_Flags ILP_DOWNLEVEL = 1;
...
# pragma pack( pop )
  ...
  int            AddMRUStringA(                HANDLE hMRU, LPCSTR szString);
  int            AddMRUStringW(                HANDLE hMRU, LPCWSTR szString);
  int            CreateMRUListA(               LPMRUINFO lpmi);
  int            CreateMRUListW(               LPMRUINFO lpmi);
  LRESULT        DefSubclassProc(              HWND hWnd, WINAPI_WinMsg uMsg, WPARAM WPARAM, LPARAM LPARAM);
  int            EnumMRUListA(                 HANDLE hMRU, int nItem, void* lpData, UINT uLen);
  ...
  HDPA           DPA_Clone(                    const HDPA hdpaSource, HDPA hdpaNew);
  ...
  int            DrawTextExPrivWrap(           HDC hdc, LPWSTR lpchText, int cchText, LPRECT lprc, UINT dwDTFormat, LPDRAWTEXTPARAMS lpDTParams);
  int            DrawTextWrapW(                HDC hdc, LPCWSTR lpString, int nCount, LPRECT lpRect, UINT uFormat, LPDRAWTEXTPARAMS lpDTParams);
  ...
  BOOL           ExtTextOutWrapW(              HDC hdc, int X, int Y, UINT uOptions, const RECT* lprc, LPCWSTR lpString, UINT cbCount, const INT* lpDx);
  void           GetEffectiveClientRect(       HWND hWnd, LPRECT lprc, const INT* lpInfo);
  LANGID         GetMUILanguage(               );
  BOOL           GetTextExtentPoint32WrapW(    HDC hdc, LPCWSTR lpString, UINT cbCount, LPSIZE lpSize);
  ...
  int            Str_GetPtrA(                  LPCSTR pszSource, LPCSTR pszDest, int cchDest);
  int            Str_GetPtrW(                  LPCWSTR pszSource, LPCSTR pszDest, int cchDest);
  BOOL           Str_SetPtrA(                  LPSTR* ppszCurrent, LPCSTR pszNew);
  BOOL           Str_SetPtrW(                  LPWSTR* ppszCurrent, LPCWSTR pszNew);
  ...
  HIMAGELIST     ImageList_LoadImageA(         HINSTANCE hi, LPCSTR lpbmp, int cx, int cGrow, COLORREF crMask, WINAPI_ImageType uType, WINAPI_LRFlags uFlags);
  HIMAGELIST     ImageList_LoadImageW(         HINSTANCE hi, LPCWSTR lpbmp, int cx, int cGrow, COLORREF crMask, WINAPI_ImageType uType, WINAPI_LRFlags uFlags);
