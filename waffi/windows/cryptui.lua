...
ffi.cdef [[
  ...
  typedef struct CRYPTUI_VIEWCERTIFICATE_STRUCTA {
    DWORD dwSize;
    HWND hwndParent;
  ...
  typedef CRYPTUI_VIEWCERTIFICATE_STRUCTA *PCCRYPTUI_VIEWCERTIFICATE_STRUCTA; //Pointer
  ...
  typedef CRYPTUI_VIEWCERTIFICATE_STRUCTW *PCCRYPTUI_VIEWCERTIFICATE_STRUCTW; //Pointer
  typedef struct CRYPTUI_VIEWSIGNERINFO_STRUCTA {
    DWORD dwSize;
    HWND hwndParent;
    DWORD dwFlags;
    LPCSTR szTitle;
  ...
  typedef struct CRYPTUI_VIEWSIGNERINFO_STRUCTW {
    DWORD dwSize;
    HWND hwndParent;
    DWORD dwFlags;
    LPCSTR szTitle;
  ...
  typedef struct CRYPTUI_SELECTCERTIFICATE_STRUCTA {
    DWORD dwSize;
    HWND hwndParent;
    DWORD dwFlags;
    LPCSTR szTitle;
  ...
  typedef CRYPTUI_SELECTCERTIFICATE_STRUCTA *PCCRYPTUI_SELECTCERTIFICATE_STRUCTA; //Pointer
  ...
  typedef CRYPTUI_SELECTCERTIFICATE_STRUCTW *PCCRYPTUI_SELECTCERTIFICATE_STRUCTW; //Pointer
  ...
  PCCERT_CONTEXT CryptUIDlgSelectCertificateA(         PCCRYPTUI_SELECTCERTIFICATE_STRUCTA pcsc);
  PCCERT_CONTEXT CryptUIDlgSelectCertificateW(         PCCRYPTUI_SELECTCERTIFICATE_STRUCTW pcsc);
  ...
  BOOL           CryptUIDlgViewCertificateA(           PCCRYPTUI_VIEWCERTIFICATE_STRUCTA pCertViewInfo, BOOL* pfPropertiesChanged);
  BOOL           CryptUIDlgViewCertificateW(           PCCRYPTUI_VIEWCERTIFICATE_STRUCTW pCertViewInfo, BOOL* pfPropertiesChanged);
  ...
  BOOL           CryptUIDlgViewSignerInfoA(            CRYPTUI_VIEWSIGNERINFO_STRUCTA* pcvsi);
  BOOL           CryptUIDlgViewSignerInfoW(            CRYPTUI_VIEWSIGNERINFO_STRUCTW* pcvsi);
]]
