...
ffi.cdef [[
  ...
  static const WINAPI_CryptConfigTable CRYPT_LOCAL = 0x00000001;
  static const WINAPI_CryptConfigTable CRYPT_DOMAIN = 0x00000002;
  typedef ULONG WINAPI_CryptInterface; //Alias
  static const WINAPI_CryptInterface BCRYPT_CIPHER_INTERFACE = 0x00000001;
  static const WINAPI_CryptInterface BCRYPT_HASH_INTERFACE = 0x00000002;
  static const WINAPI_CryptInterface BCRYPT_ASYMMETRIC_ENCRYPTION_INTERFACE = 0x00000003;
  static const WINAPI_CryptInterface BCRYPT_SECRET_AGREEMENT_INTERFACE = 0x00000004;
  static const WINAPI_CryptInterface BCRYPT_SIGNATURE_INTERFACE = 0x00000005;
  static const WINAPI_CryptInterface BCRYPT_RNG_INTERFACE = 0x00000006;
  static const WINAPI_CryptInterface NCRYPT_KEY_STORAGE_INTERFACE = 0x00010001;
  static const WINAPI_CryptInterface NCRYPT_SCHANNEL_INTERFACE = 0x00010002;
  static const WINAPI_CryptInterface NCRYPT_SCHANNEL_SIGNATURE_INTERFACE = 0x00010003;
  typedef ULONG WINAPI_CryptPriority; //Alias
  static const WINAPI_CryptPriority CRYPT_PRIORITY_TOP = 0x00000000;
  static const WINAPI_CryptPriority CRYPT_PRIORITY_BOTTOM = 0xFFFFFFFF;
  typedef ULONG WINAPI_CryptOperation; //Alias
  typedef ULONG WINAPI_CryptMode; //Alias
  static const WINAPI_CryptMode CRYPT_UM = 0x00000001;
  static const WINAPI_CryptMode CRYPT_KM = 0x00000002;
  static const WINAPI_CryptMode CRYPT_MM = 0x00000003;
  static const WINAPI_CryptMode CRYPT_ANY = 0x00000004;
