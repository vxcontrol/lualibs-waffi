...
ffi.cdef [[
  ...
  BOOL CryptRetrieveObjectByUrlA( LPCSTR pszUrl, LPCSTR pszObjectOid, WINAPI_CryptRetrievalFlags dwRetrievalFlags, DWORD dwTimeout, LPVOID* ppvObject, HCRYPTASYNC hAsyncRetrieve, PCRYPT_CREDENTIALS pCredentials, LPVOID pvVerify, PCRYPT_RETRIEVE_AUX_INFO pAuxInfo);
  BOOL CryptRetrieveObjectByUrlW( LPCWSTR pszUrl, LPCWSTR pszObjectOid, WINAPI_CryptRetrievalFlags dwRetrievalFlags, DWORD dwTimeout, LPVOID* ppvObject, HCRYPTASYNC hAsyncRetrieve, PCRYPT_CREDENTIALS pCredentials, LPVOID pvVerify, PCRYPT_RETRIEVE_AUX_INFO pAuxInfo);
]]
