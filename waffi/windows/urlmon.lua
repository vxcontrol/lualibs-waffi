...
ffi.cdef [[
  ...
  HRESULT URLDownloadToCacheFileA(                 LPUNKNOWN lpUnkcaller, LPCSTR szURL, LPSTR szFileName, DWORD cchFileName, DWORD dwReserved, IBindStatusCallback* pBSC);
  HRESULT URLDownloadToCacheFileW(                 LPUNKNOWN lpUnkcaller, LPCWSTR szURL, LPWSTR szFileName, DWORD cchFileName, DWORD dwReserved, IBindStatusCallback* pBSC);
  ...
  HRESULT URLOpenBlockingStreamA(                  LPUNKNOWN pCaller, LPCSTR szURL, LPSTREAM* ppStream, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
  HRESULT URLOpenBlockingStreamW(                  LPUNKNOWN pCaller, LPCWSTR szURL, LPSTREAM* ppStream, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
  HRESULT URLOpenPullStreamA(                      LPUNKNOWN pCaller, LPCSTR szURL, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
  HRESULT URLOpenPullStreamW(                      LPUNKNOWN pCaller, LPCWSTR szURL, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
  HRESULT URLOpenStreamA(                          LPUNKNOWN pCaller, LPCSTR szURL, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
  HRESULT URLOpenStreamW(                          LPUNKNOWN pCaller, LPCWSTR szURL, DWORD dwReserved, LPBINDSTATUSCALLBACK lpfnCB);
