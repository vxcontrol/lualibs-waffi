...
ffi.cdef [[
  ...
  typedef LPVOID ENUMRESLANGPROCA; //Alias
  typedef LPVOID ENUMRESLANGPROCW; //Alias
  typedef LPVOID ENUMRESNAMEPROCA; //Alias
  typedef LPVOID ENUMRESNAMEPROCW; //Alias
  typedef LPVOID ENUMRESTYPEPROCA; //Alias
  typedef LPVOID ENUMRESTYPEPROCW; //Alias
  ...
  static const GEOID Congo__DRC_ = 0x2C;
...
# pragma pack( pop )
  ...
  typedef struct MODULEENTRY32 {
    ...
    DWORD modBaseSize;
    HMODULE hModule;
    CHAR szModule[MAX_MODULE_NAME32_plus_1];
  ...
  typedef struct MODULEENTRY32W {
    ...
    DWORD modBaseSize;
    HMODULE hModule;
    WCHAR szModule[MAX_MODULE_NAME32_plus_1];
    WCHAR szExePath[MAX_PATH];
  } MODULEENTRY32W;
  typedef MODULEENTRY32W *LPMODULEENTRY32W; //Pointer
  ...
  typedef PROCESSENTRY32W *LPPROCESSENTRY32W; //Pointer
  ...
  typedef CPINFOEXA *LPCPINFOEXA; //Pointer
  typedef struct CPINFOEXW {
    UINT MaxCharSize;
    BYTE DefaultChar[MAX_DEFAULTCHAR];
    BYTE LeadByte[MAX_LEADBYTES];
    WCHAR UnicodeDefaultChar;
  ...
  typedef CPINFOEXW *LPCPINFOEXW; //Pointer
...
//static const WINAPI_PROCESS_THREAD_HANDLE GetCurrentThread_func_ = -2;
  ...
  BOOL                         SetThreadContext(                        WINAPI_ThreadHandle hThread, const LPVOID lpContext);
  ...
  BOOL                         GetModuleHandleExA(                      WINAPI_GetModuleHandleExFlags dwFlags, LPCSTR lpModuleName, HMODULE* phModule);
  BOOL                         GetModuleHandleExW(                      WINAPI_GetModuleHandleExFlags dwFlags, LPCWSTR lpModuleName, HMODULE* phModule);
  FARPROC                      GetProcAddress(                          HMODULE hModule, LPCSTR lpProcName);
  HMODULE                      LoadLibraryA(                            LPCSTR lpFileName);
  HMODULE                      LoadLibraryW(                            LPCWSTR lpFileName);
  HMODULE                      LoadLibraryExA(                          LPCSTR lpFileName, HANDLE hFile, WINAPI_LoadLibraryExFlags dwFlags);
  HMODULE                      LoadLibraryExW(                          LPCWSTR lpFileName, HANDLE hFile, WINAPI_LoadLibraryExFlags dwFlags);
  ...
  WINAPI_FILE_HANDLE           CreateFileA(                             LPCSTR lpFileName, WINAPI_FILE_ACCESS_MASK dwDesiredAccess, WINAPI_FileShareMode dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, WINAPI_CreationDisposition dwCreationDisposition, WINAPI_FlagsAndAttributes dwFlagsAndAttributes, HANDLE hTemplateFile);
  WINAPI_FILE_HANDLE           CreateFileW(                             LPCWSTR lpFileName, WINAPI_FILE_ACCESS_MASK dwDesiredAccess, WINAPI_FileShareMode dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, WINAPI_CreationDisposition dwCreationDisposition, WINAPI_FlagsAndAttributes dwFlagsAndAttributes, HANDLE hTemplateFile);
  WINAPI_FILE_HANDLE           CreateFileTransactedA(                   LPCSTR lpFileName, WINAPI_FILE_ACCESS_MASK dwDesiredAccess, WINAPI_FileShareMode dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, WINAPI_CreationDisposition dwCreationDisposition, WINAPI_FlagsAndAttributes dwFlagsAndAttributes, HANDLE hTemplateFile, HANDLE hTransaction, PUSHORT pusMiniVersion, PVOID pExtendedParameter);
  WINAPI_FILE_HANDLE           CreateFileTransactedW(                   LPCWSTR lpFileName, WINAPI_FILE_ACCESS_MASK dwDesiredAccess, WINAPI_FileShareMode dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, WINAPI_CreationDisposition dwCreationDisposition, WINAPI_FlagsAndAttributes dwFlagsAndAttributes, HANDLE hTemplateFile, HANDLE hTransaction, PUSHORT pusMiniVersion, PVOID pExtendedParameter);
  ...
  BOOLEAN                      CreateSymbolicLinkA(                     LPSTR lpSymlinkFileName, LPSTR lpTargetFileName, WINAPI_CreateSymbolicLinkFlags dwFlags);
  BOOLEAN                      CreateSymbolicLinkW(                     LPWSTR lpSymlinkFileName, LPWSTR lpTargetFileName, WINAPI_CreateSymbolicLinkFlags dwFlags);
  BOOLEAN                      CreateSymbolicLinkTransactedA(           LPSTR lpSymlinkFileName, LPSTR lpTargetFileName, WINAPI_CreateSymbolicLinkFlags dwFlags, HANDLE hTransaction);
  BOOLEAN                      CreateSymbolicLinkTransactedW(           LPWSTR lpSymlinkFileName, LPWSTR lpTargetFileName, WINAPI_CreateSymbolicLinkFlags dwFlags, HANDLE hTransaction);
  ...
  WINAPI_FILE_HANDLE           FindFirstFileA(                          LPCSTR lpFileName, LPWIN32_FIND_DATAA lpFindFileData);
  WINAPI_FILE_HANDLE           FindFirstFileW(                          LPCWSTR lpFileName, LPWIN32_FIND_DATAW lpFindFileData);
  WINAPI_FILE_HANDLE           FindFirstFileExA(                        LPCSTR lpFileName, FINDEX_INFO_LEVELS fInfoLevelId, LPVOID lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, LPVOID lpSearchFilter, WINAPI_FindFirstFileExFlags dwAdditionalFlags);
  WINAPI_FILE_HANDLE           FindFirstFileExW(                        LPCWSTR lpFileName, FINDEX_INFO_LEVELS fInfoLevelId, LPVOID lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, LPVOID lpSearchFilter, WINAPI_FindFirstFileExFlags dwAdditionalFlags);
  ...
  WINAPI_FILE_HANDLE           FindFirstFileTransactedA(                LPCSTR lpFileName, FINDEX_INFO_LEVELS fInfoLevelId, LPVOID lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, LPVOID lpSearchFilter, WINAPI_FindFirstFileExFlags dwAdditionalFlags, HANDLE hTransaction);
  WINAPI_FILE_HANDLE           FindFirstFileTransactedW(                LPCWSTR lpFileName, FINDEX_INFO_LEVELS fInfoLevelId, LPVOID lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, LPVOID lpSearchFilter, WINAPI_FindFirstFileExFlags dwAdditionalFlags, HANDLE hTransaction);
  ...
  BOOL                         GetBinaryTypeA(                          LPCSTR lpApplicationName, WINAPI_GetBinaryTypeResult* lpBinaryType);
  BOOL                         GetBinaryTypeW(                          LPCWSTR lpApplicationName, WINAPI_GetBinaryTypeResult* lpBinaryType);
  ...
  WINAPI_FileAttributes        GetFileAttributesA(                      LPCSTR lpFileName);
  WINAPI_FileAttributes        GetFileAttributesW(                      LPCWSTR lpFileName);
  ...
  DWORD                        GetFinalPathNameByHandleA(               HANDLE hFile, LPSTR lpszFilePath, DWORD cchFilePath, WINAPI_GetFinalPathNameByHandleFlags dwFlags);
  DWORD                        GetFinalPathNameByHandleW(               HANDLE hFile, LPWSTR lpszFilePath, DWORD cchFilePath, WINAPI_GetFinalPathNameByHandleFlags dwFlags);
  ...
  BOOL                         MoveFileExA(                             LPCSTR lpExistingFileName, LPCSTR lpNewFileName, WINAPI_MoveFileFlags dwFlags);
  BOOL                         MoveFileExW(                             LPCWSTR lpExistingFileName, LPCWSTR lpNewFileName, WINAPI_MoveFileFlags dwFlags);
  ...
  BOOL                         SetFileAttributesA(                      LPCSTR lpFileName, WINAPI_FileAttributes dwFileAttributes);
  BOOL                         SetFileAttributesW(                      LPCWSTR lpFileName, WINAPI_FileAttributes dwFileAttributes);
  BOOL                         SetFileAttributesTransactedA(            LPCSTR lpFileName, WINAPI_FileAttributes dwFileAttributes, HANDLE hTransaction);
  BOOL                         SetFileAttributesTransactedW(            LPCWSTR lpFileName, WINAPI_FileAttributes dwFileAttributes, HANDLE hTransaction);
  ...
  HANDLE                       CreateFileMappingA(                      WINAPI_FILE_HANDLE hFile, LPSECURITY_ATTRIBUTES lpAttributes, WINAPI_MemoryProtection flProtect, DWORD dwMaximumSizeHigh, DWORD dwMaximumSizeLow, LPCSTR lpName);
  HANDLE                       CreateFileMappingW(                      WINAPI_FILE_HANDLE hFile, LPSECURITY_ATTRIBUTES lpAttributes, WINAPI_MemoryProtection flProtect, DWORD dwMaximumSizeHigh, DWORD dwMaximumSizeLow, LPCWSTR lpName);
  HANDLE                       CreateFileMappingNumaA(                  WINAPI_FILE_HANDLE hFile, LPSECURITY_ATTRIBUTES lpFileMappingAttributes, WINAPI_MemoryProtection flProtect, DWORD dwMaximumSizeHigh, DWORD dwMaximumSizeLow, LPCSTR lpName, DWORD nndPreferred);
  HANDLE                       CreateFileMappingNumaW(                  WINAPI_FILE_HANDLE hFile, LPSECURITY_ATTRIBUTES lpFileMappingAttributes, WINAPI_MemoryProtection flProtect, DWORD dwMaximumSizeHigh, DWORD dwMaximumSizeLow, LPCWSTR lpName, DWORD nndPreferred);
  ...
  HANDLE                       OpenFileMappingA(                        WINAPI_MapAccessFlags dwDesiredAccess, BOOL bInheritHandle, LPCSTR lpName);
  HANDLE                       OpenFileMappingW(                        WINAPI_MapAccessFlags dwDesiredAccess, BOOL bInheritHandle, LPCWSTR lpName);
  ...
  BOOL                         CreateProcessW(                          LPCWSTR lpApplicationName, LPWSTR lpCommandLine, LPSECURITY_ATTRIBUTES lpProcessAttributes, LPSECURITY_ATTRIBUTES lpThreadAttributes, BOOL bInheritHandles, WINAPI_CreateProcessFlags dwCreationFlags, LPVOID lpEnvironment, LPCWSTR lpCurrentDirectory, LPSTARTUPINFOW lpStartupInfo, LPPROCESS_INFORMATION lpProcessInformation);
  ...
  BOOL                         QueryFullProcessImageNameA(              WINAPI_ProcessHandle hProcess, WINAPI_QueryFullProcessImageNameFlags dwFlags, LPSTR lpExeName, PDWORD lpdwSize);
  BOOL                         QueryFullProcessImageNameW(              WINAPI_ProcessHandle hProcess, WINAPI_QueryFullProcessImageNameFlags dwFlags, LPWSTR lpExeName, PDWORD lpdwSize);
  ...
  BOOL                         SetThreadGroupAffinity(                  WINAPI_ThreadHandle hThread, const GROUP_AFFINITY* GroupAffinity);
  ...
  HANDLE                       OpenJobObjectW(                          DWORD dwDesiredAccess, BOOL bInheritHandles, LPCWSTR lpName);
  ...
  HANDLE                       CreateActCtxA(                           PACTCTXA pActCtx);
  HANDLE                       CreateActCtxW(                           PACTCTXW pActCtx);
  BOOL                         DeactivateActCtx(                        WINAPI_DeactivateActCtxFlags dwFlags, ULONG_PTR ulCookie);
  BOOL                         FindActCtxSectionGuid(                   WINAPI_FIND_ACTCTX_SECTION_FLAGS dwFlags, const GUID* lpExtensionGuid, WINAPI_ACTIVATION_CONTEXT_SECTION ulSectionId, const GUID* lpGuidToFind, PACTCTX_SECTION_KEYED_DATA ReturnedData);
  BOOL                         FindActCtxSectionStringA(                WINAPI_FIND_ACTCTX_SECTION_FLAGS dwFlags, const GUID* lpExtensionGuid, WINAPI_ACTIVATION_CONTEXT_SECTION ulSectionId, LPCSTR lpStringToFind, PACTCTX_SECTION_KEYED_DATA ReturnedData);
  BOOL                         FindActCtxSectionStringW(                WINAPI_FIND_ACTCTX_SECTION_FLAGS dwFlags, const GUID* lpExtensionGuid, WINAPI_ACTIVATION_CONTEXT_SECTION ulSectionId, LPCWSTR lpStringToFind, PACTCTX_SECTION_KEYED_DATA ReturnedData);
  ...
  DWORD                        GetConsoleAliasA(                        LPSTR lpSource, LPSTR lpTargetBuffer, DWORD TargetBufferLength, LPSTR lpExeName);
  DWORD                        GetConsoleAliasW(                        LPWSTR lpSource, LPWSTR lpTargetBuffer, DWORD TargetBufferLength, LPWSTR lpExeName);
  DWORD                        GetConsoleAliasesA(                      LPSTR lpAliasBuffer, DWORD AliasBufferLength, LPSTR lpExeName);
  DWORD                        GetConsoleAliasesW(                      LPWSTR lpAliasBuffer, DWORD AliasBufferLength, LPWSTR lpExeName);
  DWORD                        GetConsoleAliasesLengthA(                LPSTR lpExeName);
  DWORD                        GetConsoleAliasesLengthW(                LPWSTR lpExeName);
  DWORD                        GetConsoleAliasExesA(                    LPSTR lpExeNameBuffer, DWORD ExeNameBufferLength);
  DWORD                        GetConsoleAliasExesW(                    LPWSTR lpExeNameBuffer, DWORD ExeNameBufferLength);
  ...
  BOOL                         ReadConsoleA(                            HANDLE hConsoleInput, LPVOID lpBuffer, DWORD nNumberOfCharsToRead, LPDWORD lpNumberOfCharsRead, LPVOID pInputControl);
  BOOL                         ReadConsoleW(                            HANDLE hConsoleInput, LPVOID lpBuffer, DWORD nNumberOfCharsToRead, LPDWORD lpNumberOfCharsRead, LPVOID pInputControl);
  ...
  BOOL                         WriteConsoleA(                           HANDLE hConsoleOutput, LPCSTR lpBuffer, DWORD nNumberOfCharsToWrite, LPDWORD lpNumberOfCharsWritten, LPVOID lpReserved);
  BOOL                         WriteConsoleW(                           HANDLE hConsoleOutput, LPCWSTR lpBuffer, DWORD nNumberOfCharsToWrite, LPDWORD lpNumberOfCharsWritten, LPVOID lpReserved);
  ...
  DWORD                        FormatMessageA(                          WINAPI_FormatMessageFlags dwFlags, LPCVOID lpSource, DWORD dwMessageId, DWORD dwLanguageId, LPSTR lpBuffer, DWORD nSize, va_list* Arguments);
  DWORD                        FormatMessageW(                          WINAPI_FormatMessageFlags dwFlags, LPCVOID lpSource, DWORD dwMessageId, DWORD dwLanguageId, LPWSTR lpBuffer, DWORD nSize, va_list* Arguments);
  ...
  BOOL                         ConvertCalDateTimeToSystemTime(          const LPCALDATETIME lpCalDateTime, SYSTEMTIME* lpSysTime);
  ...
  BOOL                         EnumCalendarInfoA(                       CALINFO_ENUMPROC pCalInfoEnumProc, LCID Locale, CALID Calendar, CALTYPE CalType);
  BOOL                         EnumCalendarInfoW(                       CALINFO_ENUMPROC pCalInfoEnumProc, LCID Locale, CALID Calendar, CALTYPE CalType);
  BOOL                         EnumCalendarInfoExA(                     CALINFO_ENUMPROCEX pCalInfoEnumProcEx, LCID Locale, CALID Calendar, CALTYPE CalType);
  BOOL                         EnumCalendarInfoExW(                     CALINFO_ENUMPROCEX pCalInfoEnumProcEx, LCID Locale, CALID Calendar, CALTYPE CalType);
  ...
  BOOL                         EnumDateFormatsA(                        DATEFMT_ENUMPROC lpDateFmtEnumProc, LCID Locale, WINAPI_GetDateFormatFlags dwFlags);
  BOOL                         EnumDateFormatsW(                        DATEFMT_ENUMPROC lpDateFmtEnumProc, LCID Locale, WINAPI_GetDateFormatFlags dwFlags);
  BOOL                         EnumDateFormatsExA(                      DATEFMT_ENUMPROCEX lpDateFmtEnumProcEx, LCID Locale, WINAPI_GetDateFormatFlags dwFlags);
  BOOL                         EnumDateFormatsExW(                      DATEFMT_ENUMPROCEX lpDateFmtEnumProcEx, LCID Locale, WINAPI_GetDateFormatFlags dwFlags);
  ...
  BOOL                         EnumLanguageGroupLocalesA(               LANGGROUPLOCALE_ENUMPROC lpLangGroupLocaleEnumProc, LGRPID LanguageGroup, DWORD dwFlags, LONG_PTR lParam);
  BOOL                         EnumLanguageGroupLocalesW(               LANGGROUPLOCALE_ENUMPROC lpLangGroupLocaleEnumProc, LGRPID LanguageGroup, DWORD dwFlags, LONG_PTR lParam);
  BOOL                         EnumSystemCodePagesA(                    CODEPAGE_ENUMPROC lpCodePageEnumProc, WINAPI_CodePageEnumerationFlags dwFlags);
  BOOL                         EnumSystemCodePagesW(                    CODEPAGE_ENUMPROC lpCodePageEnumProc, WINAPI_CodePageEnumerationFlags dwFlags);
  BOOL                         EnumSystemGeoID(                         GEOCLASS GeoClass, GEOID ParentGeoId, GEO_ENUMPROC lpGeoEnumProc);
  BOOL                         EnumSystemLanguageGroupsA(               LANGUAGEGROUP_ENUMPROC lpLanguageGroupEnumProc, DWORD dwFlags, LONG_PTR lParam);
  BOOL                         EnumSystemLanguageGroupsW(               LANGUAGEGROUP_ENUMPROC lpLanguageGroupEnumProc, DWORD dwFlags, LONG_PTR lParam);
  BOOL                         EnumSystemLocalesA(                      LOCALE_ENUMPROC lpLocaleEnumProc, WINAPI_LocaleEnumerationFlags dwFlags);
  BOOL                         EnumSystemLocalesW(                      LOCALE_ENUMPROC lpLocaleEnumProc, WINAPI_LocaleEnumerationFlags dwFlags);
  ...
  BOOL                         EnumTimeFormatsA(                        TIMEFMT_ENUMPROC lpTimeFmtEnumProc, LCID Locale, WINAPI_GetTimeFormatFlags dwFlags);
  BOOL                         EnumTimeFormatsW(                        TIMEFMT_ENUMPROC lpTimeFmtEnumProc, LCID Locale, WINAPI_GetTimeFormatFlags dwFlags);
  ...
  int                          FoldStringA(                             WINAPI_MappingFlags dwMapFlags, LPCSTR lpSrcStr, int cchSrc, LPSTR lpDestStr, int cchDest);
  int                          FoldStringW(                             WINAPI_MappingFlags dwMapFlags, LPCWSTR lpSrcStr, int cchSrc, LPWSTR lpDestStr, int cchDest);
  UINT                         GetACP(                                  );
  ...
  BOOL                         GetCPInfoExA(                            WINAPI_CodePageEnum CodePage, DWORD dwFlags, LPCPINFOEXA lpCPInfoEx);
  BOOL                         GetCPInfoExW(                            WINAPI_CodePageEnum CodePage, DWORD dwFlags, LPCPINFOEXW lpCPInfoEx);
  ...
  int                          GetDateFormatA(                          LCID Locale, WINAPI_GetDateFormatFlags dwFlags, const SYSTEMTIME* lpDate, LPCSTR lpFormat, LPSTR lpDateStr, int cchDate);
  int                          GetDateFormatW(                          LCID Locale, WINAPI_GetDateFormatFlags dwFlags, const SYSTEMTIME* lpDate, LPCWSTR lpFormat, LPWSTR lpDateStr, int cchDate);
  int                          GetDateFormatEx(                         LPCWSTR lpLocaleName, WINAPI_GetDateFormatFlags dwFlags, const SYSTEMTIME* lpDate, LPCWSTR lpFormat, LPWSTR lpDateStr, int cchDate, LPCWSTR lpCalendar);
  ...
  int                          GetNumberFormatA(                        LCID Locale, WINAPI_GetNumberFormatFlags dwFlags, LPCSTR lpValue, const NUMBERFMTA* lpFormat, LPSTR lpNumberStr, int cchNumber);
  int                          GetNumberFormatW(                        LCID Locale, WINAPI_GetNumberFormatFlags dwFlags, LPCWSTR lpValue, const NUMBERFMTW* lpFormat, LPWSTR lpNumberStr, int cchNumber);
  int                          GetNumberFormatEx(                       LPCWSTR lpLocaleName, WINAPI_GetNumberFormatFlags dwFlags, LPCWSTR lpValue, const NUMBERFMTW* lpFormat, LPWSTR lpNumberStr, int cchNumber);
  UINT                         GetOEMCP(                                );
  ...
  int                          GetTimeFormatA(                          LCID Locale, WINAPI_GetTimeFormatFlags dwFlags, const SYSTEMTIME* lpTime, LPCSTR lpFormat, LPSTR lpTimeStr, int cchTime);
  int                          GetTimeFormatW(                          LCID Locale, WINAPI_GetTimeFormatFlags dwFlags, const SYSTEMTIME* lpTime, LPCWSTR lpFormat, LPWSTR lpTimeStr, int cchTime);
  int                          GetTimeFormatEx(                         LPCWSTR lpLocaleName, WINAPI_GetTimeFormatFlags dwFlags, const SYSTEMTIME* lpTime, LPCWSTR lpFormat, LPWSTR lpTimeStr, int cchTime);
  ...
  int                          LCMapStringA(                            LCID Locale, WINAPI_LocaleMappingFlags dwMapFlags, LPCSTR lpSrcStr, int cchSrc, LPSTR lpDestStr, int cchDest);
  int                          LCMapStringW(                            LCID Locale, WINAPI_LocaleMappingFlags dwMapFlags, LPCWSTR lpSrcStr, int cchSrc, LPWSTR lpDestStr, int cchDest);
  ...
  BOOL                         EnumResourceNamesA(                      HMODULE hModule, LPCSTR lpszType, ENUMRESNAMEPROCA lpEnumFunc, LONG_PTR lParam);
  BOOL                         EnumResourceNamesW(                      HMODULE hModule, LPCWSTR lpszType, ENUMRESNAMEPROCW lpEnumFunc, LONG_PTR lParam);
  BOOL                         EnumResourceNamesExA(                    HMODULE hModule, LPCSTR lpszType, ENUMRESNAMEPROCA lpEnumFunc, LONG_PTR lParam, WINAPI_ResourceEnumFlags dwFlags, LANGID LangId);
  BOOL                         EnumResourceNamesExW(                    HMODULE hModule, LPCWSTR lpszType, ENUMRESNAMEPROCW lpEnumFunc, LONG_PTR lParam, WINAPI_ResourceEnumFlags dwFlags, LANGID LangId);
  ...
  int                          CompareStringA(                          LCID Locale, WINAPI_StringFlags dwCmpFlags, LPCSTR lpString1, int cchCount1, LPCSTR lpString2, int cchCount2);
  int                          CompareStringW(                          LCID Locale, WINAPI_StringFlags dwCmpFlags, LPCWSTR lpString1, int cchCount1, LPCWSTR lpString2, int cchCount2);
  ...
  BOOL                         GetStringTypeExA(                        LCID Locale, WINAPI_CharacterTypeFlag dwInfoType, LPCSTR lpSrcStr, int cchSrc, LPWORD lpCharType);
  BOOL                         GetStringTypeExW(                        LCID Locale, WINAPI_CharacterTypeFlag dwInfoType, LPCWSTR lpSrcStr, int cchSrc, LPWORD lpCharType);
  ...
  HANDLE                       CreateEventExA(                          LPSECURITY_ATTRIBUTES lpEventAttributes, LPCSTR lpName, DWORD dwFlags, WINAPI_EventAccessRights dwDesiredAccess);
  HANDLE                       CreateEventExW(                          LPSECURITY_ATTRIBUTES lpEventAttributes, LPCWSTR lpName, DWORD dwFlags, WINAPI_EventAccessRights dwDesiredAccess);
  HANDLE                       OpenEventA(                              WINAPI_EventAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCSTR lpName);
  HANDLE                       OpenEventW(                              WINAPI_EventAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCWSTR lpName);
  ...
  HANDLE                       CreateMutexExA(                          LPSECURITY_ATTRIBUTES lpMutexAttributes, LPCSTR lpName, DWORD dwFlags, WINAPI_MutexAccessRights dwDesiredAccess);
  HANDLE                       CreateMutexExW(                          LPSECURITY_ATTRIBUTES lpMutexAttributes, LPCWSTR lpName, DWORD dwFlags, WINAPI_MutexAccessRights dwDesiredAccess);
  HANDLE                       OpenMutexA(                              WINAPI_MutexAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCSTR lpName);
  HANDLE                       OpenMutexW(                              WINAPI_MutexAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCWSTR lpName);
  ...
  HANDLE                       CreateSemaphoreExA(                      LPSECURITY_ATTRIBUTES lpSemaphoreAttributes, LONG lInitialCount, LONG lMaximumCount, LPCSTR lpName, DWORD dwFlags, WINAPI_SemaphoreAccessRights dwDesiredAccess);
  HANDLE                       CreateSemaphoreExW(                      LPSECURITY_ATTRIBUTES lpSemaphoreAttributes, LONG lInitialCount, LONG lMaximumCount, LPCWSTR lpName, DWORD dwFlags, WINAPI_SemaphoreAccessRights dwDesiredAccess);
  HANDLE                       OpenSemaphoreA(                          WINAPI_SemaphoreAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCSTR lpName);
  HANDLE                       OpenSemaphoreW(                          WINAPI_SemaphoreAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCWSTR lpName);
  ...
  WINAPI_WAIT_RESULT           WaitForMultipleObjects(                  DWORD nCount, const HANDLE* lpHandles, BOOL bWaitAll, WINAPI_WaitTimeout dwMilliseconds);
  WINAPI_WAIT_RESULT           WaitForMultipleObjectsEx(                DWORD nCount, const HANDLE* lpHandles, BOOL bWaitAll, WINAPI_WaitTimeout dwMilliseconds, BOOL bAlertable);
  ...
  HANDLE                       CreateWaitableTimerExA(                  LPSECURITY_ATTRIBUTES lpTimerAttributes, LPCSTR lpTimerName, DWORD dwFlags, WINAPI_TimerAccessRights dwDesiredAccess);
  HANDLE                       CreateWaitableTimerExW(                  LPSECURITY_ATTRIBUTES lpTimerAttributes, LPCWSTR lpTimerName, DWORD dwFlags, WINAPI_TimerAccessRights dwDesiredAccess);
  HANDLE                       OpenWaitableTimerA(                      WINAPI_TimerAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCSTR lpTimerName);
  HANDLE                       OpenWaitableTimerW(                      WINAPI_TimerAccessRights dwDesiredAccess, BOOL bInheritHandle, LPCWSTR lpTimerName);
  ...
  BOOL                         SetFirmwareEnvironmentVariableA(         LPCSTR lpName, LPCSTR lpGuid, PVOID pBuffer, DWORD nSize);
  BOOL                         SetFirmwareEnvironmentVariableW(         LPCWSTR lpName, LPCWSTR lpGuid, PVOID pBuffer, DWORD nSize);
  BOOL                         VerifyVersionInfoA(                      LPOSVERSIONINFOEXA lpVersionInfo, WINAPI_NtVerType dwTypeMask, DWORDLONG dwlConditionMask);
  BOOL                         VerifyVersionInfoW(                      LPOSVERSIONINFOEXW lpVersionInfo, WINAPI_NtVerType dwTypeMask, DWORDLONG dwlConditionMask);
  ...
  DWORD                        VerLanguageNameA(                        DWORD wLang, LPWSTR szLang, DWORD cchLang);
  ...
  HANDLE                       FindFirstChangeNotificationA(            LPCSTR lpPathName, BOOL bWatchSubtree, WINAPI_FILE_NOTIFY_CHANGE_FLAGS dwNotifyFilter);
  HANDLE                       FindFirstChangeNotificationW(            LPCWSTR lpPathName, BOOL bWatchSubtree, WINAPI_FILE_NOTIFY_CHANGE_FLAGS dwNotifyFilter);
  ...
  BOOL                         GetDiskFreeSpaceExW(                     LPCWSTR lpDirectoryName, PULARGE_INTEGER lpFreeBytesAvailable, PULARGE_INTEGER lpTotalNumberOfBytes, PULARGE_INTEGER lpTotalNumberOfFreeBytes);
  BOOL                         DefineDosDeviceA(                        WINAPI_DDD_FLAGS dwFlags, LPCSTR lpDeviceName, LPCSTR lpTargetPath);
  BOOL                         DefineDosDeviceW(                        WINAPI_DDD_FLAGS dwFlags, LPCWSTR lpDeviceName, LPCWSTR lpTargetPath);
  ...
  WINAPI_DRIVE_TYPE            GetDriveTypeA(                           LPCSTR lpRootPathName);
  WINAPI_DRIVE_TYPE            GetDriveTypeW(                           LPCWSTR lpRootPathName);
  DWORD                        GetLogicalDrives(                        );
  DWORD                        GetLogicalDriveStringsA(                 DWORD nBufferLength, LPSTR lpBuffer);
  DWORD                        GetLogicalDriveStringsW(                 DWORD nBufferLength, LPWSTR lpBuffer);
  BOOL                         GetVolumeInformationA(                   LPCSTR lpRootPathName, LPSTR lpVolumeNameBuffer, DWORD nVolumeNameSize, LPDWORD lpVolumeSerialNumber, LPDWORD lpMaximumComponentLength, WINAPI_LPFILE_SYSTEM_FLAGS lpFileSystemFlags, LPSTR lpFileSystemNameBuffer, DWORD nFileSystemNameSize);
  BOOL                         GetVolumeInformationW(                   LPCWSTR lpRootPathName, LPWSTR lpVolumeNameBuffer, DWORD nVolumeNameSize, LPDWORD lpVolumeSerialNumber, LPDWORD lpMaximumComponentLength, WINAPI_LPFILE_SYSTEM_FLAGS lpFileSystemFlags, LPWSTR lpFileSystemNameBuffer, DWORD nFileSystemNameSize);
  BOOL                         GetVolumeInformationByHandleW(           HANDLE hFile, LPWSTR lpVolumeNameBuffer, DWORD nVolumeNameSize, LPDWORD lpVolumeSerialNumber, LPDWORD lpMaximumComponentLength, WINAPI_LPFILE_SYSTEM_FLAGS lpFileSystemFlags, LPWSTR lpFileSystemNameBuffer, DWORD nFileSystemNameSize);
  ...
  BOOL                         CallNamedPipeA(                          LPCSTR lpNamedPipeName, LPVOID lpInBuffer, DWORD nInBufferSize, LPVOID lpOutBuffer, DWORD nOutBufferSize, LPDWORD lpBytesRead, WINAPI_NMPWAIT nTimeOut);
  BOOL                         CallNamedPipeW(                          LPCWSTR lpNamedPipeName, LPVOID lpInBuffer, DWORD nInBufferSize, LPVOID lpOutBuffer, DWORD nOutBufferSize, LPDWORD lpBytesRead, WINAPI_NMPWAIT nTimeOut);
  BOOL                         ConnectNamedPipe(                        HANDLE hNamedPipe, LPOVERLAPPED lpOverlapped);
  HANDLE                       CreateNamedPipeA(                        LPCSTR lpName, WINAPI_PIPE_ACCESS dwOpenMode, WINAPI_PIPE_MODE dwPipeMode, DWORD nMaxInstances, DWORD nOutBufferSize, DWORD nInBufferSize, DWORD nDefaultTimeOut, LPSECURITY_ATTRIBUTES lpSecurityAttributes);
  HANDLE                       CreateNamedPipeW(                        LPCWSTR lpName, WINAPI_PIPE_ACCESS dwOpenMode, WINAPI_PIPE_MODE dwPipeMode, DWORD nMaxInstances, DWORD nOutBufferSize, DWORD nInBufferSize, DWORD nDefaultTimeOut, LPSECURITY_ATTRIBUTES lpSecurityAttributes);
  ...
  BOOL                         GetNamedPipeHandleStateA(                HANDLE hNamedPipe, WINAPI_PIPE_STATE* lpState, LPDWORD lpCurInstances, LPDWORD lpMaxCollectionCount, LPDWORD lpCollectDataTimeout, LPSTR lpUserName, DWORD nMaxUserNameSize);
  BOOL                         GetNamedPipeHandleStateW(                HANDLE hNamedPipe, WINAPI_PIPE_STATE* lpState, LPDWORD lpCurInstances, LPDWORD lpMaxCollectionCount, LPDWORD lpCollectDataTimeout, LPWSTR lpUserName, DWORD nMaxUserNameSize);
  ...
  BOOL                         WaitNamedPipeA(                          LPCSTR lpNamedPipeName, WINAPI_NMPWAIT nTimeOut);
  BOOL                         WaitNamedPipeW(                          LPCWSTR lpNamedPipeName, WINAPI_NMPWAIT nTimeOut);
