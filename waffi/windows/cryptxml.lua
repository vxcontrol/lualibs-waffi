...
ffi.cdef [[
  ...
  HRESULT CryptXmlCreateReference(  HCRYPTXML hCryptXml, DWORD dwFlags, LPCWSTR wszId, LPCWSTR wszURI, LPCWSTR wszType, const CRYPT_XML_ALGORITHM* pDigestMethod, ULONG cTransform, const CRYPT_XML_ALGORITHM* rgTransform, HCRYPTXML* phReference);
  HRESULT CryptXmlAddObject(        HCRYPTXML hSignatureOrObject, DWORD dwFlags, const CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, const PCRYPT_XML_BLOB pEncoded, const CRYPT_XML_OBJECT** ppObject);
  ...
  HRESULT CryptXmlEncode(           HCRYPTXML hCryptXml, CRYPT_XML_CHARSET dwCharset, const CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, void* pvCallbackState, PFN_CRYPT_XML_WRITE_CALLBACK pfnWrite);
  HRESULT CryptXmlGetAlgorithmInfo( const CRYPT_XML_ALGORITHM* pXmlAlgorithm, DWORD dwFlags, CRYPT_XML_ALGORITHM_INFO** ppAlgInfo);
  HRESULT CryptXmlGetDocContext(    HCRYPTXML hCryptXml, const CRYPT_XML_DOC_CTXT** ppStruct);
  HRESULT CryptXmlGetReference(     HCRYPTXML HCRYPTXML, const CRYPT_XML_REFERENCE** ppStruct);
  HRESULT CryptXmlGetSignature(     HCRYPTXML hCryptXml, const CRYPT_XML_SIGNATURE** ppStruct);
  ...
  HRESULT CryptXmlOpenToDecode(     CRYPT_XML_TRANSFORM_CHAIN_CONFIG* pConfig, DWORD dwFlags, const CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, const CRYPT_XML_BLOB* pEncoded, HCRYPTXML phCryptXml);
  HRESULT CryptXmlSetHMACSecret(    HCRYPTXML hSignature, const BYTE* pbSecret, ULONG cbSecret);
  HRESULT CryptXmlVerifySignature(  HCRYPTXML hSignature, BCRYPT_KEY_HANDLE hKey, DWORD dwFlags);
  HRESULT CryptXmlSign(             HCRYPTXML hSignature, HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hKey, DWORD dwKeySpec, DWORD dwFlags, CRYPT_XML_KEYINFO_SPEC dwKeyInfoSpec, const void* pvKeyInfoSpec, const CRYPT_XML_ALGORITHM* pSignatureMethod, const CRYPT_XML_ALGORITHM* pCanonicalization);
]]
